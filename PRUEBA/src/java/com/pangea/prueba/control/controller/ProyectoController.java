...
import com.pangea.prueba.control.modelo.bean.ProyectoFacade;
...
public class ProyectoController implements Serializable {
    ...
    @EJB
    private com.pangea.prueba.control.modelo.bean.ProyectoFacade ejbFacade;
    ...
    public static class ProyectoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Proyecto) {
                ...
                return getStringKey(o.getPoryectoid());
            } else {
